      ...
      <nav className="fixed w-full z-50 bg-white/70 backdrop-blur-md border-b border-green-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8 font-medium text-green-800">
            ...
            <a href="#" className="hover:text-green-600 transition">Impact</a>
          </div>
          <button className="bg-green-600 hover:bg-green-700 text-white px-5 py-2 rounded-full font-medium transition shadow-lg shadow-green-200">
            Login / Register
          </button>
        </div>
      </nav>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-green-500 hover:bg-green-400 text-green-950 px-8 py-4 rounded-full font-bold text-lg flex items-center justify-center gap-2 transition shadow-xl">
              I am a Farmer <ArrowRight className="h-5 w-5" />
            </button>
            <button className="bg-white/20 hover:bg-white/30 backdrop-blur-md text-white border border-white/50 px-8 py-4 rounded-full font-bold text-lg transition shadow-xl">
              Corporate Orders
            </button>
          </div>
        </div>
